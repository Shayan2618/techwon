 ...
 * @since 1.0.0
 */
class BdevsServicesHomeSlider extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-services-home-slider';
	}
	...
	public function get_title() {
		return __( 'Services Home Slider ', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Services Home Slider', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'subheading',
	                ...
	                <div class="item">
	                    <div class="wrap">
	                        ...
	                        <div class="con">
	                            ...
	                            <?php }else{?>
	                            <?php echo esc_attr(acens_excerpt2(20)); } ?></p>
	                            <div class="icon-2">
