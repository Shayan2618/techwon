 ...
 * @since 1.0.0
 */
class BdevsTestimonialPages extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-testimonial-pages';
	}
	...
	public function get_keywords() {
		return [ 'Testimonial Pages', 'carousel' ];
	}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                <div class="item"> 
                    <span class="quote"><i class="<?php echo wp_kses_post($item['icon']); ?>"></i></span>
