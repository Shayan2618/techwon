...
$args = array(
	...
	'menu_title'                => esc_html__( 'Acens Options', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Acens Options', 'your-textdomain-here' ),
...
Redux::setSection($opt_name, array(
                'icon' => 'el-icon-cogs',
                'title' => __('General Settings', 'acens'),
                'fields' => array(  
                    array(
                        'id' => 'favicon',
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Favicon Upload', 'acens'),
                        'compiler' => 'true',
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Favicon.', 'acens'),
                        'default' => ''
                    ), 
                    array(
                        'id' => 'logo',
                        ...
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Logo Image', 'acens'),
                        'default' => ''
                    ),
                    array(
                        'id' => 'logo_dark',
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Sticky Logo', 'acens'),
                        'compiler' => 'true',
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Sticky Logo Image', 'acens'),
                        'default' => ''
                    ),  
                    array(
                        'id' => 'home',
            ...
            Redux::setSection($opt_name, array(
                'icon' => 'el-icon-list',
                'title' => __('Blog Settings', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'image_single',
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Background Image Single', 'acens'),
                        'compiler' => 'true',
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Background Image Single', 'acens'),
                        'default' => ''
                    ), 
                    array(
                        'id' => 'blog_single',
                        'type' => 'text',
                        'title' => __('Blog Single', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => 'Blog'
                     ),
                    array(
                        'id' => 'link_blog_single',
                        'type' => 'text',
                        'title' => __('Link Blog Single', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '#'
                     ),
                    array(
                        'id' => 'link_blog_single_dark',
                        'type' => 'text',
                        'title' => __('Link Blog Single Dark', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '#'
                     ),
                    array(
                        'id' => 'subtitle_single',
                        'type' => 'text',
                        'title' => __('Subtitle Single', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => 'Post Single'
                     ),
                    array(
                        ...
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Background Blog Image', 'acens'),
                        'compiler' => 'true',
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Background Blog Image', 'acens'),
                        'default' => ''
                    ), 
                    array(
                        'id' => 'blog_title',
                        'type' => 'text',
                        'title' => __('Blog Title', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                    ...
                    array(
                        'id' => 'blog_excerpt',
                        'type' => 'text',
                        'title' => __('Blog custom excerpt leng', 'acens'),
                        'subtitle' => __('Input Blog custom excerpt leng', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '50'
                    ),
                )
            ...
            Redux::setSection($opt_name, array(
                'icon' => 'el-icon-list',
                'title' => __('Services Settings', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'image_services',
                        'type' => 'media',
                    ...
                    array(
                        'id' => 'services_single',
                        'type' => 'text',
                        'title' => __('Services Single', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => 'Services'
                     ),
                    array(
                        'id' => 'link_services',
                        'type' => 'text',
                        'title' => __('Link Services Single', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '#'
                     ),
                    array(
                        'id' => 'link_blog_single_dark',
                        'type' => 'text',
                        'title' => __('Link Services Single Dark', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '#'
                     ),
            ...
            Redux::setSection($opt_name, array(
                'icon' => 'el-icon-graph',
                'title' => __('404 Settings', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'image_error',
                        'type' => 'media',
                        'url' => true,
                        'title' => __('Background Image Error', 'acens'),
                        'compiler' => 'true',
                        //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc' => __('', 'acens'),
                        'subtitle' => __('Upload your Background Image Error', 'acens'),
                        'default' => ''
                    ), 
                    array(
                        'id' => 'error',
                        'type' => 'text',
                        'title' => __('Error title', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                    ...
                    array(
                        'id' => 'text',
                        'type' => 'textarea',
                        'title' => __('Description', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => 'The page you are looking for was moved, removed, renamed or never existed.'
                     ),
                    array(
                        'id' => 'home_page',
                        'type' => 'text',
                        'title' => __('Back to home', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
            ...
            Redux::setSection($opt_name, array(
                ...
                'title' => __('Header Settings', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'icon_phone',
                        'type' => 'text',
                        'title' => __('Icon Phone', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
            ...
            Redux::setSection($opt_name, array(
                'icon' => ' el-icon-credit-card',
                'title' => __('Footer Settings', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'footer_copyright',
                        'type' => 'text',
                        'title' => __('Copyright', 'acens'),
                        'subtitle' => __('', 'acens'),
                        'desc' => __('', 'acens'),
                        'default' => '© 2024 All Rights Reserved, by SHThemes'
                    ), 
                )
            ));
            ...
            Redux::setSection($opt_name, array(
                ...
                'title' => __('Styling Options', 'acens'),
                'fields' => array(
                    array(
                        'id' => 'chosen-color',
                        'type' => 'checkbox',
                        'title' => __('Enable edit color', 'acens'),
                        'subtitle' => '',
                        'desc' => '',
                    ...
                    array(
                        'id' => 'main-color-1',
                        'type' => 'color',
                        'title' => __('Theme Main Color 1', 'acens'),
                        'subtitle' => __('Pick the main color for the theme (default: #ffe79b).', 'acens'),
                        'default' => '#dc2751',
                        'validate' => 'color',
                    ),
                )
