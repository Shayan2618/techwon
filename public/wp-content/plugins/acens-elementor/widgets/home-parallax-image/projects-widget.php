...
class BdevsProjects extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Projects Home Parallax Image', 'bdevs-elementor' );
	}
	...
	public function render() {
		...
		extract($settings);
		?> 
<section id="works" data-scroll-index="2" class="works section-padding bg-drk">
    <div class="container">
        <div class="row mb-30">
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="wrap img-grayscale">
                            <div class="img img-grayscale"> <img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id());?>" class="img-fluid"> </div>
                            <div class="text">
