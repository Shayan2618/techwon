 ...
 * @since 1.0.0
 */
class BdevsGalleryPages extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Gallery Image Other Pages', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Gallery Other Pages', 'bdevs-elementor' ),
			]	
		);
		$this->add_control(
			'all',
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="gallery-filter">
                    <li class="active" data-filter="*"><?php echo wp_kses_post($settings['all']); ?></li>
                    <?php
		        	$b = 0;
        ...
        <div class="row gallery-items">
        	<?php
	            ...
	            $i++;
            ?> 
            <div class="col-lg-4 col-md-6 single-item <?php echo esc_attr($cate_slug);?> mb-25">
                <a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id());?>" title="" class="img-zoom">
                    <div class="gallery-box">
                        <div class="gallery-img img-grayscale"> 
                        <img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id());?>" class="img-fluid mx-auto d-block" alt=""> </div>
