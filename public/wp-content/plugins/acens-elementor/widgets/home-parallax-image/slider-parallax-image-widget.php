 ...
 * @since 1.0.0
 */
class BdevsSliderParallaxImage extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-slider-parallax-image';
	}
	...
	public function get_title() {
		return __( 'Slider Parallax Image', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sliders Parallax Image', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Creative Solutions', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Book Appointment', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?>  
<section id="home" data-scroll-index="0" class="parallax-header valign bg-img" data-overlay-dark="6" data-background="<?php print esc_url($settings['image']['url']); ?>">
    <div class="container">
